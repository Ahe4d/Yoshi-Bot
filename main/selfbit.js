...
try{
    var selfbitAbout = require("./selfbit.json");
}

catch(e){
    console.log("No 'selfbit.json'... are you a pirate?");
    process.exit();
}
try {
...
console.log("\x1b[36m", selfbitAbout.name, "\x1b[35m", selfbitConfig.version, "\x1b[0m");
console.log("\x1b[36m", "by " + selfbitAbout.author, "\x1b[35m", selfbitAbout.github, "\x1b[0m");
